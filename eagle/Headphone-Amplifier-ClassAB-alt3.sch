...
http://www.electronics-diy.com/4x4.php</description>
 ...
 grid 5.08 mm, diameter 5 mm</description>
      ...
      <parts>
        ...
        <part name="C1" library="c" deviceset="CPOL-H" device="E2,5-3" value="4.7uF" />
        <part name="R5" library="r" deviceset="POT" device="-3P" value="100k" />
        <part name="C2" library="c" deviceset="CPOL-H" device="E2,5-3" value="4.7uF" />
        <part name="S1" library="pad" deviceset="GND" device="" />
        <part name="S2" library="pad" deviceset="GND" device="" />
        <part name="C3" library="c" deviceset="CPOL-H" device="E2,5-5/V" value="470uF" />
        <part name="C4" library="c" deviceset="CPOL-H" device="E5-4" value="100uF" />
