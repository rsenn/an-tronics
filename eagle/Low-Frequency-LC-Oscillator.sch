...
<description>Low-Frequency LC Oscillator
	   		
Basically a Hartley oscillator using a triple-emitter follower, this oscillator can be used at audio and low radio frequencies. The frequency is given by: At 1 kHz, typically C would be 4.7uF tantalums, but this is only a guide as to convenient values to use. 

http://www.next.gr/oscillators/sine-wave/low-frequency-lc-oscillator-l14396.html</description>
<libraries>
<library name="t">
...
<text x="0" y="3.175" size="0.8128" layer="27" ratio="10" align="bottom-center">&gt;VALUE</text>
...
<part name="R1" library="r" deviceset="R" device="0204/10" value="1MΩ"/>
<part name="R2" library="r" deviceset="R" device="0204/10" value="1MΩ"/>
<part name="R3" library="r" deviceset="R" device="0204/10" value="470Ω"/>
...
<part name="C2" library="c" deviceset="CPOL" device="E2.5-5"/>
<part name="C3" library="c" deviceset="CPOL" device="E2.5-5"/>
...
<part name="C4" library="c" deviceset="CPOL" device="E2,5-3" value="4u7"/>
</parts>
<sheets>
<sheet>
<plain>
